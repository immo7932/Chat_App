...
const UpdateGroupChatModal = ({ fetchChatAgain, setFetchAgain, fetchMessages }) => {
    ...
    const { selectedChat, setSelectedChat, user } = useContext(StoreContext);
    ...
    const handleAddUser = async (user1) => {
        ...
        // console.log("direct id", selectedChat._id)
